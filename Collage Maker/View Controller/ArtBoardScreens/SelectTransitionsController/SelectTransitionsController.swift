...
class SelectTransitionsController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
  ...
  // MARK: Transition Collection View
    ...
    private func setUpLineView() {
        ...
        NSLayoutConstraint.activate([
            ...
            lineView.widthAnchor.constraint(equalToConstant: 78)
        ])
    }
